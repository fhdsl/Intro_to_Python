...
[**Try it out, share with what you tried**](https://docs.google.com/document/d/1qchQimLvbxtSRVDuzLcoDMQU2jbg6xgJ5ZHXJ6c7P5I/edit?usp=sharing)
...
```{python}
myplot = sns.displot(data=metadata, x="Age", hue="Sex", multiple="dodge", palette=sns.color_palette(palette='rainbow'))
myplot.set_titles("my title")
myplot.set_xlabels("new x label")
plt.show()
```

## Other plot customization via [Better Plots workshop](https://better-plots.netlify.app/)

## Reference for Seaborn plotting

<https://seaborn.pydata.org/tutorial.html>

## [Cheatsheet](https://docs.google.com/document/d/1BJzDaUeIjF1kOVx1RXoWhtHqAGORfUy8eDK0kmnybLE/edit?usp=sharing)
